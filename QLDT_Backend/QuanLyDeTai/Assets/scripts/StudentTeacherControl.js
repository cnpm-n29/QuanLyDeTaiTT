...
function changeDropKhoaHoc(IDKH) {
    ...
    $.ajax({
        async: false,
        url: "/StudentTeacher/GetByMaKhoaHoc?IDKH=" + IDKH + "&IDGV=" + IDGV,
        type: "GET",
        ...
        success: function (result) {
            ...
            if (result.Student == "") {
                ...
                $.each(result.Student, function (key, item) {
                    ...
                    if (result.TeacherName[n] == null) {
                        html += '<td></td>';
                        n++;
                    } else {
                        html += '<td>' + result.TeacherName[n++] + '</td>';
                    }
                    html += "</tr>";
...
function Deleted(IDSV) {
    ...
    while (i < tr1.length) {
        ...
        if (IDSV == td.textContent) {
            ...
            $.ajax({
                async: false,
                url: "/StudentTeacher/GetForReturn?IDSV=" + IDSV,
                type: "GET",
                contentType: "application/json;charset=UTF-8",
                dataType: "json",
                success: function (result) {
...
function DeleteInDatabase(IDSV) {
    $.ajax({
        async: false,
        url: "/StudentTeacher/Delete?IDSV=" + IDSV,
        type: "GET",
        contentType: "application/json;charset=UTF-8",
        dataType: "json",
        success: function (result) {
