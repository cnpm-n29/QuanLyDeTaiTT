        ...
        success: function (result) {
            ...
            if (result == "") {
                ...
                $.each(result, function (key, item) {
                    ...
                    html += ' <td align="center"><a href="suadetai" onclick="getbyID(' + item.ID + ')"><i class="fa fa-edit"></i></a></td>';
...
function getListHocKy() {
    $.ajax({
        ...
        success: function (result) {
            ...
            var html = '<select id="HocKy" class="form-control" onchange = "changeDropHocKy(this.value)">';
